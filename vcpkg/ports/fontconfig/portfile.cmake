# Overlay fontconfig 端口（照搬 vcpkg 上游 baseline b1e15ef）。
#
# 修复：vcpkg meson 交叉编译在 Android arm64 上被错推为 armv7，报
#   ld.lld: error: .../libiconv.a(...) is incompatible with armelf_linux_eabi
#   ld.lld: error: undefined symbol: libiconv_open
# 与 glib 同根因。在 vcpkg_configure_meson 之前 include 共享模块
# _meson_android_arm64.cmake 注入 aarch64 交叉覆盖，见该文件注释。
